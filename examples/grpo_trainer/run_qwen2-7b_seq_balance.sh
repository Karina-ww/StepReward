...
DATA_HOME=/data/yutianyu
DATA_HOME=/mnt/data/user/tc_agi/user/tc_agi/yutianyu
MODEL_HOME=$DATA_HOME
export VLLM_ATTENTION_BACKEND=XFORMERS

export http_proxy=10.97.64.39:18000 && export https_proxy=10.97.64.39:18000
WANDB_PRJ_NAME=verl_grpo_example_gsm8k
...
python -m verl.trainer.main_ppo \
    ...
    data.train_files=$DATA_HOME/data/gsm8k/train.parquet \
    data.val_files=$DATA_HOME/data/gsm8k/test.parquet \
