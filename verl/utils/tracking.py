...
class Tracking(object):
    ...
    def __init__(self, project_name, experiment_name, default_backend: Union[str, List[str]] = 'console', config=None):
        ...
        if 'tracking' in default_backend or 'wandb' in default_backend:
            import wandb
            print(f"{dict(project=project_name, name=experiment_name, config=config, dir=config['wandb_dir'], entity=config.get('wandb_entity', None))=}")
            wandb.init(project=project_name, name=experiment_name, config=config, dir=config['wandb_dir'], entity=config.get('wandb_entity', None))
...
class _TensorboardAdapter:
    def __init__(self):
        ...
        import os
        tensorboard_dir = os.environ.get("TENSORBOARD_DIR", "./data/logs/tensorboard")
